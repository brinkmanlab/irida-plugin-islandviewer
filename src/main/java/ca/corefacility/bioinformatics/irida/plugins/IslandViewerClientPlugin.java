 ...
 */
public class IslandViewerClientPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType ISLANDVIEWERCLIENT = new AnalysisType("ISLANDVIEWERCLIENT");

	public IslandViewerClientPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		 ...
		 * 
		 * <pre>
		 * {@code <analysisType>ISLANDVIEWERCLIENT</analysisType>}
		 * </pre>
		 * 
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("852bc2d9-e848-4ce5-a3d7-740f880a9f5b");
		}
